  ...
  return (
    <div className="relative overflow-x-auto">
      <table className="table w-full min-w-[700px] font-sans tabular-nums text-sm">
        <thead className="uppercase bg-base-200 dark:bg-[#222426] text-base-content/80 dark:text-gray-200">
          <tr>
            <th className="sticky left-0 z-10 bg-base-200 dark:bg-[#222426]">
              Final Reviewer Name
            </th>
